...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.3717; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -3; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.03412616; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.04931794; // Multiplier in the Y direction
